        ...
        <div class="sidebar-category sidebar-category-visible">
            <div class="category-content no-padding">
                <ul class="navigation navigation-main navigation-accordion">
                    ...
                    <!-- Main -->
                    <li class="navigation-header"><span>Danh sách các tính năng</span> <i class="icon-menu"
                            title="" data-original-title="Cách tính năng"></i></li>
                    <li>
                        <a href="#"><img src="../assets/images/icons/sys/placeholder-outline.svg"
                                style="width: 32px;" /> <span>ĐỊA PHƯƠNG</span></a>
                        <ul>
                            <li><a href="sys_thanhpho.php">Thành phố</a></li>
                            <li><a href="sys_quanhuyen.php">Quận huyện</a></li>
                            <li><a href="sys_phuongxa.php">Phường xã</a></li>
                        </ul>
                    </li>
                    <li>
                        <a href="#"><img src="../assets/images/icons/sys/school.svg" style="width: 32px;" />
                            <span>TỔ CHỨC</span></a>
                        <ul>
                            <li><a href="sys_tochuc.php">Tổ chức</a></li>
                            <li><a href="sys_loaitochuc.php">Loại tổ chức</a></li>
                            <li><a href="sys_hinhthuctochuc.php">Hình thức tổ chức</a></li>
                            <li><a href="sys_quimotochuc.php">Qui mô tổ chức</a></li>
                        </ul>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="sys_product.php"><img src="../assets/images/icons/admin/parcel.svg"
                                style="width: 32px;" />
                    ...
                    <li>
                        <a href="#"><img src="../assets/images/icons/sys/big-license.svg"
                                style="width: 32px;" />
                    ...
                    <li>
                        <a href="sys_uudaiscfamily.php"><img
                                src="../assets/images/icons/sys/voucher_1332606.svg" style="width: 32px;" />
                            <span>ƯU ĐÃI CÙNG SCFAMILY</span></a>
                    </li>
                    <li>
